    ...
    while True:
        for (
            ...
            (
                (images_a, mask_a),
                (images_b, mask_b),
                (images_as, images_bs, mask_s, sem_a, sem_b),
            ),
        ) in enumerate(
            ...
            with Timer("Elapsed time in update s: %f"):
                ...
                if (
                    ...
                    and (iterations + 1) % config["adaptation"]["classif_frequency"]
                    == 0
                ):
                    print(iterations + 1)
                ...
                if (
                    ...
                    and (iterations + 1) % config["adaptation"]["output_classif_freq"]
                    == 0
                ):
                ...
                if config["synthetic_frequency"] > 0:
                    if iterations % config["synthetic_frequency"] == 0:
                        ...
                        if (
                            trainer.use_classifier_sr
                            and (iterations + 1)
                            % config["adaptation"]["classif_frequency"]
                            == 0
                        ):
                            trainer.domain_classifier_sr_update(
                                images_as,
